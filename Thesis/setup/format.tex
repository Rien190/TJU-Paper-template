...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\song\wuhao \@cheading}  % 页眉显示设定的文字
...
\def\makecover{
  ...
  \begin{titlepage}
    ...
    \begin{center}
      ...
      \vspace*{21pt}
      \hei\erhao{\textbf{《XXXXXX》课程报告}} % 设置封面课程报告名称
      \vspace*{52.5pt}
      ...
      %\vspace*{5pt}
      %\hei\sanhao{\textbf{题目：{\@ctitle}}} % 设置封面题目
      %\vspace*{24pt}
      ...
      {\xiaosan\song{\bf{
            \begin{tabular}{ll}
              学\quad 院： & \underline{\makebox[\@title@width][c]{\@caffil}}      \\
              专\quad 业： & \underline{\makebox[\@title@width][c]{\@csubject}}    \\
              年\quad 级： & \underline{\makebox[\@title@width][c]{\@cgrade}}      \\
              姓\quad 名： & \underline{\makebox[\@title@width][c]{\@cauthor}}     \\
              学\quad 号： & \underline{\makebox[\@title@width][c]{\@cnumber}}     \\
            \end{tabular}}}
      }
      \vspace*{21pt}
